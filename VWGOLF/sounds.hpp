...
class	Sounds
{
	...
	#define HZ_IDLE FACTOR_RPM(267,767)
	#define HZ_RPM1 FACTOR_RPM(600,1400)
	#define HZ_RPM2 FACTOR_RPM(867,2067)
	#define HZ_RPM3 FACTOR_RPM(1500,2033)
	#define HZ_RPM4 FACTOR_RPM(2200,3267)
	#define HZ_RPM5 FACTOR_RPM(2800,4133)
	#define HZ_RPM6 FACTOR_RPM(3400,4600)

	
	#define VOLUME_IDLE FACTOR2_RPM(200,500,700,900)
	#define VOLUME_RPM1 FACTOR2_RPM(780,833,967,1400)
	#define VOLUME_RPM2 FACTOR2_RPM(833,1367,1533,2067)
	#define VOLUME_RPM3 FACTOR2_RPM(1500,2033,2200,2733)
	#define VOLUME_RPM4 FACTOR2_RPM(2167,2700,2800,3247)
	#define VOLUME_RPM5 FACTOR2_RPM(2767,3200,3433,4100)
	#define VOLUME_RPM6 FACTOR_RPM(3400,4067)


	
	class	Idle_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-Idle-1", db+15,	1, 150};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*VOLUME_IDLE;
	};
	class	Engine
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-low-1",	db+16,1, 200};
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*camPos*VOLUME_RPM1;
	};
	class	Engine1_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-1",	db+13,1, 240};
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*camPos*VOLUME_RPM2;
	};
	class	Engine2_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-2",	db+11,1, 280};
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*camPos*VOLUME_RPM3;
	};
	class	Engine3_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-2",	db+10,1, 320};
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*camPos*VOLUME_RPM4;
	};
	class	Engine4_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-2",	db+9,1, 360};
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*camPos*VOLUME_RPM5;
	};
	class	Engine5_ext
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-3",	db+8,1, 420};
 	...
 	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-2", db0,1, 400};
		frequency	=	0.8	+	HZ_RPM5*0.3;
		volume = engineOn*camPos*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM5;
  	};
  	class Engine5_Thrust_ext
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\ext\ext-golf-high-3", db2,1, 450};
	...
	class	Idle_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-Idle-1", db+14,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*VOLUME_IDLE;
	};
	class	Engine_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-low-1",	db+16,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM1;
	};
	class	Engine1_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-1",	db+12,1 };
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM2;
	};
	class	Engine2_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2",	db+11,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM3;
	};
	class	Engine3_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2",	db+10,1 };
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM4;
	};
	class	Engine4_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2",	db+9,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM5;
	};
	class	Engine5_int
	{
		sound[]	=	{"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-3",	db+6,1 };
		frequency	=	0.95	+	HZ_RPM6*0.15;
	...
	/*   POD PLYNEM   */
  	...
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-acce-1", db+10,1 };
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_IDLE;
  	};
  	class EngineThrust_int
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-low-1", db+9,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM1;
  	};
  	class Engine1_Thrust_int
  	{
   		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-1", db+8,1 };
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM2;
  	};
  	class Engine2_Thrust_int
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2", db+7,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM3;
  	};
  	class Engine3_Thrust_int
  	{
   		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2", db+6,1 };
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM4;
  	};
  	class Engine4_Thrust_int
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-2", db+5,1 };
		frequency	=	0.8	+	HZ_RPM5*0.3;
		volume = engineOn*(1-camPos)*(0.4+(0.6*FACTOR(thrust,0.1,1)))*VOLUME_RPM5;
  	};
  	class Engine5_Thrust_int
  	{
    		sound[] = {"rds_a2port_civ\data\sounds\GOLF\int\int-golf-high-3", db+4,1 };
		frequency	=	0.9	+	HZ_RPM6*0.2;
